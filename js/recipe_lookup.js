$( function() {
    ...
    function Row() {
        this.$elem = $('<div/>').addClass( 'row' )
        this.$suggest = $('<input/>').attr( { type: 'text' } ).addClass( 'form-control' )
        this.$calories = $('<div/>').addClass( 'calories col-xs-1' )
        this.$quantity = $('<input/>').attr( { type: 'text' } ).addClass( 'form-control' )
        this.$units = get_$units().addClass( 'form-control' )
        this.$notes = $('<textarea/>').addClass( 'form-control' )
        
        var $icon = $('<div/>').addClass( 'icon col-xs-1' )
        ...
        this.$elem
            ...
            .append(
                $('<div/>')
                    ...
                    .append( this.$units ) )
            .append(
                $('<div/>').addClass( 'notes col-xs-3' ).append( this.$notes )
            )
            .append( this.$calories )
            .append(
                $('<div/>').addClass( 'controls col-xs-1' )
                    .append(
